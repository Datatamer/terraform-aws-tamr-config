module "tamr-config" {
  ...
  es_domain_endpoint             = "${var.name_prefix}_es_domain_endpoint" // module.tamr-es-cluster.tamr_es_domain_endpoint
  ...
  # Backup
  tamr_backup_emr_cluster_id = "${var.name_prefix}_tamr_backup_emr_cluster_id" // module.emr.tamr_emr_cluster_id
}
